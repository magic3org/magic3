...
<div class="data-control-id-491 bd-currency-3" data-responsive-menu="false" data-responsive-levels="">
    <div class="data-control-id-238541 bd-horizontalmenu clearfix">
        <div class="bd-container-inner">
            <?php ob_start(); ?>
            <div class="bd-menu-55-popup">
    
    <ul class="data-control-id-238561 bd-menu-55">
        <?php foreach($currencies as $currency):?>
            <?php if ($currency->virtuemart_currency_id == $virtuemart_currency_id) : ?>
                <?php $activeCurrency = $currency; ?>
            <?php endif; ?>
            <li class="data-control-id-238562 bd-menuitem-55">
    <?php 
        $uri = JFactory::getURI();
   ...
   <a href="<?php echo $url; ?>" class="<?php if ($currency->virtuemart_currency_id == $virtuemart_currency_id) : ?> active<?php endif; ?>">
       <span><?php echo $currency->currency_txt;?></span>
        ...
        <?php endforeach; ?>
            ...
            <ul class="data-control-id-238542 bd-menu-54 nav nav-pills navbar-left">
    <li class="data-control-id-238543 bd-menuitem-54">
