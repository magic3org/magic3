...
ob_start();
?>
<li class="data-control-id-237859 bd-menuitem-3">
<?php 
$menuStartItem = ob_get_clean();
ob_start();
?>

<ul class="data-control-id-237858 bd-menu-3 nav navbar-left nav-pills<?php echo $class_sfx;?>" <?php echo $tag_id; ?>>
<?php
$bHMenu = ob_get_clean();
$eHMenu = "</ul>";
?>
...
ob_start();
?>
<li class="data-control-id-237878 bd-menuitem-4">
<?php $subMenuStartItem = ob_get_clean(); ?>
    ...
    if ($item->deeper) {
        ...
        ?>
        <div class="bd-menu-4-popup"><ul class="data-control-id-237877 bd-menu-4">
        <?php
    }
