...
<?php if (!empty($this->intro_items)) : ?>
    ...
    <?php foreach ($this->intro_items as $key => $item) : ?>
        ...
        <div class="<?php echo $itemClass; ?>" itemprop="blogPost" itemscope itemtype="http://schema.org/BlogPosting">
            <div class="data-control-id-630034 bd-griditem-30">
        <?php
            $this->item = $item;
            echo $this->loadTemplate('item');
        ?>
...
<?php if (!empty($this->intro_items)) : ?>
    ...
    <?php foreach ($this->intro_items as $key => $item) : ?>
        ...
        ?>
        <div class="<?php echo $itemClass; ?>" itemprop="blogPost" itemscope itemtype="http://schema.org/BlogPosting">
            <div class="data-control-id-630247 bd-griditem-46">
        <?php
            $this->item = $item;
            echo $this->loadTemplate('item');
        ?>
...
<?php if (!empty($this->intro_items)) : ?>
    ...
    <?php foreach ($this->intro_items as $key => $item) : ?>
        ...
        ?>
        <div class="<?php echo $itemClass; ?>" itemprop="blogPost" itemscope itemtype="http://schema.org/BlogPosting">
            <div class="data-control-id-630136 bd-griditem-38">
        <?php
            $this->item = $item;
            echo $this->loadTemplate('item');
        ?>
...
<?php if (!empty($this->intro_items)) : ?>
    ...
    <?php foreach ($this->intro_items as $key => $item) : ?>
        ...
        ?>
        <div class="<?php echo $itemClass; ?>" itemprop="blogPost" itemscope itemtype="http://schema.org/BlogPosting">
            <div class="data-control-id-628701 bd-griditem-12">
        <?php
            $this->item = $item;
            echo $this->loadTemplate('item');
        ?>
...
<?php if (!empty($this->intro_items)) : ?>
    ...
    <?php foreach ($this->intro_items as $key => $item) : ?>
        ...
        ?>
        <div class="<?php echo $itemClass; ?>" itemprop="blogPost" itemscope itemtype="http://schema.org/BlogPosting">
            <div class="data-control-id-628879 bd-griditem-23">
        <?php
            $this->item = $item;
            echo $this->loadTemplate('item');
        ?>
