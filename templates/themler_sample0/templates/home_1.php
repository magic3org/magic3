...
?>
 ...
 active"><a href="#" data-target="#carousel-1" data-slide-to="0"></a></li>
    ...
    <div class="bd-container-inner">
        <div class="bd-container-inner-wrapper">
            <div class=" bd-animation-4 animated" style="display:none"data-animation-name="fadeInLeft"
                                    data-animation-event="slidein"
                                    data-animation-duration="1000ms"
                                    data-animation-delay="0ms"
                                    data-animation-infinited="false">
<div class=" bd-animation-3 animated" data-animation-name="fadeOutLeft"
                                    data-animation-event="slideout"
                                    data-animation-duration="1000ms"
                                    data-animation-delay="0ms"
                                    data-animation-infinited="false">
<img class="bd-imagestyles bd-imagelink-1 hidden-xs   " src="<?php echo JURI::base() . 'templates/' . JFactory::getApplication()->getTemplate(); ?>/images/designer/7c67db6270d1f35cd950cb2add81ed86default_image.png"></div>
</div>
	
		<div class=" bd-animation-6 animated" style="display:none"data-animation-name="fadeInRight"
                                    data-animation-event="slidein"
                                    data-animation-duration="1000ms"
                                    data-animation-delay="0ms"
                                    data-animation-infinited="false">
<div class=" bd-animation-5 animated" data-animation-name="fadeOutRight"
                                    ...
                                    data-animation-duration="1000ms"
                                    data-animation-delay="0ms"
                                    data-animation-infinited="false"><div class=" bd-textblock-13 bd-tagstyles">
    <p>Enjoy DESIGN,</p>
<p>while THEMLER codes!</p>
    ...
    <div class="bd-container-inner">
        <div class="bd-container-inner-wrapper">
            <div class=" bd-animation-10 animated" style="display:none"data-animation-name="fadeInRight"
                                    data-animation-event="slidein"
                                    data-animation-duration="1000ms"
                                    data-animation-delay="0ms"
                                    data-animation-infinited="false">
<div class=" bd-animation-9 animated" data-animation-name="fadeOutRight"
                                    data-animation-event="slideout"
                                    data-animation-duration="1000ms"
                                    data-animation-delay="0ms"
                                    data-animation-infinited="false">
<img class="bd-imagestyles bd-imagelink-2 hidden-xs   " src="<?php echo JURI::base() . 'templates/' . JFactory::getApplication()->getTemplate(); ?>/images/designer/135c133a6460adbc143861a9e5acd566default_image.png"></div>
</div>
	
		<div class=" bd-animation-8 animated" style="display:none"data-animation-name="fadeInLeft"
                                    data-animation-event="slidein"
                                    data-animation-duration="1000ms"
                                    data-animation-delay="0ms"
                                    data-animation-infinited="false">
<div class=" bd-animation-7 animated" data-animation-name="fadeOutLeft"
                                    data-animation-event="slideout"
                                    data-animation-duration="1000ms"
                                    data-animation-delay="0ms"
                                    data-animation-infinited="false"><div class=" bd-textblock-14 bd-tagstyles">
