...
/*BEGIN_EDITOR_CLOSE*/ ?>
<?php
$filePath = dirname(dirname(dirname(__FILE__))) . '/includes/language';
if (file_exists($filePath . '/default_language_' . $attribs['id'] . '.php')) {
    include($filePath . '/default_language_' . $attribs['id'] . '.php');
} else {
?>
