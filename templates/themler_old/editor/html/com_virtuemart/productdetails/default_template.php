    ...
    <div class="bd-container-inner">
        <div class="container-fluid">
            <div class="row
                ...
                ">
                <div class="data-control-id-2362 bd-layoutcolumn-col-64 
 col-md-14">
...
<?php endif ?></div></div>
		...
		<div class="data-control-id-2364 bd-layoutcolumn-col-65 
 col-md-10">
...
<div class="data-control-id-2342 bd-productprice-5 product-prices">
    ...
    ?>
        ...
        <span class="data-control-id-2308 bd-label-18">
    ...
    ?>
        ...
        <span class="data-control-id-2274 bd-label-17">
...
<form method="post" class="product" action="<?php echo JRoute::_ ('index.php'); ?>">
    ...
    <?php if (!VmConfig::get('use_as_catalog', 0)) : ?>
        ...
        <?php if (($stockhandle == 'disableit' or $stockhandle == 'disableadd') and ($productItems->productBuy->product_in_stock - $productItems->productBuy->product_ordered) < 1) : ?>
            <?php
                echo JHTML::link (JRoute::_ ('index.php?option=com_virtuemart&view=productdetails&layout=notify&virtuemart_product_id=' . $productItems->productBuy->virtuemart_product_id), vmText::_ ('COM_VIRTUEMART_CART_NOTIFY'), array('class' => 'data-control-id-2360 bd-productbuy-4 bd-button notify'));
            ?>
        <?php else : ?>
            <?php
                ...
                if (!(VmConfig::get('askprice', true) and empty($tmpPrice))) {
                    if (isset($productItems->productBuy->orderable) && $productItems->productBuy->orderable) {
                        ...
                        $button = JHTML::link ($productItems->productBuy->link, JText::_ ('COM_VIRTUEMART_CART_ADD_TO'),
                            array('title' => $productItems->productBuy->product_name, 'class' => 'data-control-id-2360 bd-productbuy-4 bd-button'));
...
<?php endif; ?></div></div>
    ...
    <div class="data-control-id-962326 bd-accordion accordion">
    <div class="data-control-id-967993 bd-menuitem-15 accordion-item"></div>
    <div class="data-control-id-968003 bd-container-78 bd-tagstyles accordion-content"></div>
</div>
</div>
