<?php function article_6($data) {
    ...
    ?>
        ...
        <article class="data-control-id-1695 bd-article-6"<?php echo $attr; ?>>
    ...
    <div class="bd-container-inner">
        <div class="container-fluid">
            <div class="row
                ...
                ">
                <div class="data-control-id-1543 bd-layoutcolumn-col-49 
 col-md-12">
...
<div class="data-control-id-1531 bd-posticondate-12">
    <span class="data-control-id-1530 bd-icon-59"><span><?php
...
<?php endif; ?></div></div>
		...
		<div class="data-control-id-1545 bd-layoutcolumn-col-50 
 col-md-12">
...
<div class="data-control-id-1540 bd-posticonauthor-13">
    <span class="data-control-id-1539 bd-icon-61"><span><?php echo $data['author-icon']; ?></span></span>
</div>
<?php endif; ?></div></div>
</div>
            </div>
    ...
    <div class="bd-container-inner">
        <div class="container-fluid">
            <div class="row
                ...
                ">
                <div class="data-control-id-1591 bd-layoutcolumn-col-51 
 col-md-8">
...
<div class="data-control-id-1588 bd-posticoncategory-14">
    <span class="data-control-id-1587 bd-icon-62"><span><?php echo $data['category-icon']; ?></span></span>
</div>
<?php endif; ?></div></div>
</div>
            </div>
