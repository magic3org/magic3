...
<div class="data-control-id-1124219 bd-posticondate-15">
    <span class="data-control-id-1124218 bd-icon-4"><span><?php
...
<div class="data-control-id-567405 bd-extendedpostimage-1">
    ...
    <?php if ($caption): ?>
    <div class="data-control-id-1106404 bd-container-13 bd-tagstyles ">
        <?php echo $caption; ?>
    </div>
    <?php endif; ?>
</div>
