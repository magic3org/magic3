...
function joomlaposition_block_7($caption, $content, $classes = '', $id = '', $extraClass = '')
{
    ...
    ob_start();
    ?>
    <div class="data-control-id-858658 bd-block-17 <?php echo $classes; ?>" <?php echo $id; ?>>
<div class="bd-container-inner">
    <?php if ($hasCaption) : ?>
    
    <div class="data-control-id-858659 bd-blockheader bd-tagstyles bd-custom-blockquotes bd-custom-button bd-custom-image bd-custom-inputs bd-custom-bulletlist bd-custom-orderedlist bd-custom-table">
