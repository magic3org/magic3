...
function pagination_list_render_1($list)
{
    ...
    ob_start();
?>
    <ul class="data-control-id-2918 bd-pagination-5 pagination">
    <?php if ($list['start']['active']) : ?>
        <li class="data-control-id-2917 bd-paginationitem-5">
    ...
    <?php foreach($list['pages'] as $page) : ?>
        <?php if (!$page['active']) : ?>
            <li class="active data-control-id-2917 bd-paginationitem-5">
        <?php else : ?>
            <li class="data-control-id-2917 bd-paginationitem-5">
        <?php endif; ?>
