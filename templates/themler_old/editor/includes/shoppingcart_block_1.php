...
function shoppingcart_block_1($caption, $content, $classes = '', $id = '')
{
    ...
    <div class="data-control-id-3535 bd-blockheader bd-tagstyles bd-custom-blockquotes bd-custom-button bd-custom-image bd-custom-table">
...
<?php endif; ?>
    ...
    <div class="data-control-id-3567 bd-blockcontent bd-tagstyles bd-custom-blockquotes bd-custom-button bd-custom-image bd-custom-table">
