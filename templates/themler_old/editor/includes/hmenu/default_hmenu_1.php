...
ob_start();
?>
<li class="data-control-id-237859 bd-menuitem-1">
<?php 
$menuStartItem = ob_get_clean();
ob_start();
?>

<ul class="data-control-id-237858 bd-menu-1 nav navbar-right nav-pills<?php echo $class_sfx;?>" <?php echo $tag_id; ?>>
<?php
$bHMenu = ob_get_clean();
$eHMenu = "</ul>";
?>
...
ob_start();
?>
<li class="data-control-id-237878 bd-menuitem-2">
<?php $subMenuStartItem = ob_get_clean(); ?>
    ...
    if ($item->deeper) {
        ...
        ?>
        <div class="bd-menu-2-popup"><ul class="data-control-id-237877 bd-menu-2">
        <?php
    }
