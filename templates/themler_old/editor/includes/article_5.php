<?php function article_5($data) {
    ...
    ?>
        ...
        <article class="data-control-id-1444 bd-article-5"<?php echo $attr; ?>>
    ...
    <div class="bd-container-inner">
        <div class="container-fluid">
            <div class="row
                ...
                ">
                <div class="data-control-id-1305 bd-layoutcolumn-col-45 
 col-md-12">
...
<div class="data-control-id-1293 bd-posticondate-10">
    <span class="data-control-id-1292 bd-icon-54"><span><?php
...
<?php endif; ?></div></div>
		...
		<div class="data-control-id-1307 bd-layoutcolumn-col-46 
 col-md-12">
...
<div class="data-control-id-1302 bd-posticonauthor-11">
    <span class="data-control-id-1301 bd-icon-56"><span><?php echo $data['author-icon']; ?></span></span>
</div>
<?php endif; ?></div></div>
</div>
            </div>
