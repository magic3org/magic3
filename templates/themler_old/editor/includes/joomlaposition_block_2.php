...
function joomlaposition_block_2($caption, $content, $classes = '', $id = '', $extraClass = '')
{
    ...
    ob_start();
    ?>
    <div class="data-control-id-54346 bd-block-7 <?php echo $classes; ?>" <?php echo $id; ?>>
...
<?php endif; ?>
    ...
    <div class="bd-blockcontent bd-tagstyles bd-custom-bulletlist<?php echo $extraClass;?>">
