...
function hmenu_3() {
    ...
    <?php if ($isPreview || $modulesContains) : ?>
        ...
        <nav class="data-control-id-849416 bd-hmenu-3" data-responsive-menu="true" data-responsive-levels="">
            <?php if ($view->containsModules('hmenu')) : ?>
            
                <div class="data-control-id-849415 bd-responsivemenu-2 collapse-button">
    <div class="bd-container-inner">
        <div class="data-control-id-890796 bd-menuitem-21">
