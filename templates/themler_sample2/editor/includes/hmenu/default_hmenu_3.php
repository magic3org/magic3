...
$skip = false;
?>
<div class="data-control-id-849377 bd-horizontalmenu-5 clearfix">
    <div class="bd-container-inner">
        <?php
$mIconClassName = '';
ob_start();
?>
<li class="data-control-id-849379 bd-menuitem-10">
<?php 
$menuStartItem = ob_get_clean();
ob_start();
?>

<ul class="data-control-id-849378 bd-menu-9 nav navbar-left nav-pills<?php echo $class_sfx;?>" <?php echo $tag_id; ?>>
<?php
$bHMenu = ob_get_clean();
$eHMenu = "</ul>";
?>
...
ob_start();
?>
<li class="data-control-id-849391 bd-menuitem-13">
<?php $subMenuStartItem = ob_get_clean(); ?>
    ...
    if ($item->deeper) {
        ...
        ?>
        <div class="bd-menu-10-popup"><ul class="data-control-id-849390 bd-menu-10">
        <?php
    }
