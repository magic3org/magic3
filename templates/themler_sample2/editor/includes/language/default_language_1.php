...
<form name="lang" method="post" action="<?php echo JURI::current(); ?>">
    <div class="data-control-id-238921 bd-horizontalmenu-2 clearfix">
        <?php ob_start(); ?>
        <div class="bd-menu-4-popup">
    
    <ul class="data-control-id-238941 bd-menu-4">
        <?php foreach($list as $language):?>
            <?php if($language->active):?>
                <?php $activeLang = $language; ?>
            <?php endif; ?>
            <li dir=<?php echo JLanguage::getInstance($language->lang_code)->isRTL() ? '"rtl"' : '"ltr"'?> class="data-control-id-238942 bd-menuitem-5">
        ...
        <ul class="data-control-id-238922 bd-menu-3 nav nav-pills nav-justified">
    <li class="data-control-id-238923 bd-menuitem-4">
