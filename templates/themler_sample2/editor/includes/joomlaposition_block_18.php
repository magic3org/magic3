...
function joomlaposition_block_18($caption, $content, $classes = '', $id = '', $extraClass = '')
{
    ...
    ob_start();
    ?>
    <div class="data-control-id-812353 bd-block-13 <?php echo $classes; ?>" <?php echo $id; ?>>
<div class="bd-container-inner">
    <?php if ($hasCaption) : ?>
    
    <div class="data-control-id-812354 bd-blockheader bd-tagstyles bd-custom-blockquotes bd-custom-button bd-custom-image bd-custom-inputs bd-custom-bulletlist bd-custom-orderedlist bd-custom-table">
