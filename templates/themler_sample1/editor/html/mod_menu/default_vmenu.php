...
<div class="data-control-id-2779 bd-vmenu-1" data-responsive-menu="true" data-responsive-levels="">
    <div class="data-control-id-2778 bd-block <?php echo $params->get('moduleclass_sfx'); ?>">
        <?php if ($hasCaption) : ?>
        <div class="data-control-id-2745 bd-container-58 bd-tagstyles">
            <h4><?php echo $caption; ?></h4>
        </div>
        <?php endif; ?>
        <div class="data-control-id-2777 bd-container-48 bd-tagstyles shape-only">
