...
<div class="data-control-id-2519 bd-productreviews-1">
    ...
    <span class='data-control-id-2375 bd-icon-3 <?php echo $active ?>'></span>
    <?php endfor; ?>
</div>
</div>
                        <?php
    ...
    <form method="post" action="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=' . $this->product->virtuemart_product_id . '&virtuemart_category_id=' . $this->product->virtuemart_category_id); ?>" name="reviewForm" id="reviewform">
            ...
            <br/>
            <textarea class="data-control-id-2496 bd-bootstrapinput form-control input-sm" title="<?php echo JText::_ ('COM_VIRTUEMART_WRITE_REVIEW') ?>"  id="comment" onblur="refresh_counter();" onfocus="refresh_counter();" onkeyup="refresh_counter();" name="comment" rows="5" cols="60"><?php if (!empty($this->review->comment)) {
    ...
    <?php for ($i = 1; $i <= $maxrating; $i++) : ?>
    <span class="data-control-id-2507 bd-icon-3 active"></span>
    <?php endfor; ?>
</div>
            ...
            <div class="review-count">
                <span><?php echo JText::_ ('COM_VIRTUEMART_REVIEW_COUNT') ?>
                    <input type="text" value="0" size="4" class="data-control-id-2496 bd-bootstrapinput form-control input-sm" name="counter" maxlength="4" readonly="readonly"/>
                </span>
            </div>
