<?php function article_4($data) {
    ...
    ?>
        ...
        <article class="data-control-id-3275 bd-article-4">
            <h2 class="data-control-id-1229 bd-postheader-4">
    ...
    <?php endif; ?>
		...
		<div class="data-control-id-1262 bd-postcontent-4 bd-tagstyles">
    <div class="bd-container-inner">
