...
?>
    <ul class="data-control-id-2918 bd-pagination-4 pagination">
    <?php if ($list['start']['active']) : ?>
        <li class="data-control-id-2917 bd-paginationitem-4">
    ...
    <?php foreach($list['pages'] as $page) : ?>
        <?php if (!$page['active']) : ?>
            <li class="active data-control-id-2917 bd-paginationitem-4">
        <?php else : ?>
            <li class="data-control-id-2917 bd-paginationitem-4">
        <?php endif; ?>
