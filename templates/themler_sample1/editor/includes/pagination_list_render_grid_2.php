...
function pagination_list_render_grid_2($list)
{
    ...
    ob_start();
?>
    <ul class="data-control-id-1966 bd-pagination pagination">
    <?php if ($list['start']['active']) : ?>
        <li class="data-control-id-1965 bd-paginationitem-1">
	...
	<?php foreach($list['pages'] as $page) : ?>
		<?php if (!$page['active']) : ?>
            <li class="active data-control-id-1965 bd-paginationitem-1">
        <?php else : ?>
    		<li class="data-control-id-1965 bd-paginationitem-1">
		<?php endif; ?>
