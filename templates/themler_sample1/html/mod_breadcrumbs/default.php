...
/*BEGIN_EDITOR_CLOSE*/ ?>
<?php
$filePath = dirname(dirname(dirname(__FILE__))) . '/includes/breadcrumbs';
?>
<?php if (isset($attribs['id']) && '' !== $attribs['id']) : ?>
    <?php include($filePath . '/default_breadcrumbs_' . $attribs['id'] . '.php'); ?>
<?php else : ?>
