...
<div class=" bd-productreviews-1">
    ...
    <form method="post" action="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=' . $this->product->virtuemart_product_id . '&virtuemart_category_id=' . $this->product->virtuemart_category_id); ?>" name="reviewForm" id="reviewform">
            ...
            <br/>
            <textarea class=" bd-bootstrapinput form-control input-sm" title="<?php echo JText::_ ('COM_VIRTUEMART_WRITE_REVIEW') ?>"  id="comment" onblur="refresh_counter();" onfocus="refresh_counter();" onkeyup="refresh_counter();" name="comment" rows="5" cols="60"><?php if (!empty($this->review->comment)) {
    ...
    <?php endfor; ?>
            ...
            <div class="review-count">
                <span><?php echo JText::_ ('COM_VIRTUEMART_REVIEW_COUNT') ?>
                    <input type="text" value="0" size="4" class=" bd-bootstrapinput form-control input-sm" name="counter" maxlength="4" readonly="readonly"/>
                </span>
            </div>
