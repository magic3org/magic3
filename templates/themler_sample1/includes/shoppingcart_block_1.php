...
function shoppingcart_block_1($caption, $content, $classes = '', $id = '')
{
    ...
    <div class=" bd-container-55 bd-tagstyles bd-custom-blockquotes bd-custom-button bd-custom-imagestyles bd-custom-table">
...
<?php endif; ?>
    ...
    <div class=" bd-container-56 bd-tagstyles bd-custom-blockquotes bd-custom-button bd-custom-imagestyles bd-custom-table">
