        ...
        <div class="container-fluid">
            <div class="row no-gutter popup-gallery">
                <div class="col-lg-4 col-sm-6">
                    <a href="/magic3/templates/bs_single_orange/img/portfolio/fullsize/1.jpg" class="portfolio-box">
                        <img src="/magic3/templates/bs_single_orange/img/portfolio/thumbnails/1.jpg" class="img-responsive" alt="">
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="/magic3/templates/bs_single_orange/img/portfolio/fullsize/2.jpg" class="portfolio-box">
                        <img src="/magic3/templates/bs_single_orange/img/portfolio/thumbnails/2.jpg" class="img-responsive" alt="">
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                <div class="project-category text-faded">
                                    Category
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="/magic3/templates/bs_single_orange/img/portfolio/fullsize/3.jpg" class="portfolio-box">
                        <img src="/magic3/templates/bs_single_orange/img/portfolio/thumbnails/3.jpg" class="img-responsive" alt="">
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                <div class="project-category text-faded">
                                    Category
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="/magic3/templates/bs_single_orange/img/portfolio/fullsize/4.jpg" class="portfolio-box">
                        <img src="/magic3/templates/bs_single_orange/img/portfolio/thumbnails/4.jpg" class="img-responsive" alt="">
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                <div class="project-category text-faded">
                                    Category
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="/magic3/templates/bs_single_orange/img/portfolio/fullsize/5.jpg" class="portfolio-box">
                        <img src="/magic3/templates/bs_single_orange/img/portfolio/thumbnails/5.jpg" class="img-responsive" alt="">
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                <div class="project-category text-faded">
                                    Category
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="/magic3/templates/bs_single_orange/img/portfolio/fullsize/6.jpg" class="portfolio-box">
                        <img src="/magic3/templates/bs_single_orange/img/portfolio/thumbnails/6.jpg" class="img-responsive" alt="">
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                <div class="project-category text-faded">
                                    Category
