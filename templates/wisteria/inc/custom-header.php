...
add_action( 'after_setup_theme', 'wisteria_custom_header_setup' );

if ( ! function_exists( 'wisteria_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog
 *
 * @see wisteria_custom_header_setup().
 */
function wisteria_header_style() {
?>
