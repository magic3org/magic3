...
class ScriptLibInfo
{
	...
	private static $jQueryVersionArray = array(	'1.6'	=> 'jquery-1.6.4.min.js',// jQueryバージョン
												...
												'1.11'	=> 'jquery-1.11.1.min.js',
												'2.0'	=> 'jquery-2.0.3.min.js',
												'2.1'	=> 'jquery-2.1.1.min.js');
...
//	const BOOTSTRAP_BOOTSWATCH_FLATLY_CSS			= 'bootstrap-3.1.1/css/bootswatch_flatly_ja.css';	// bootstrap配色(日本語フォント)
	...
	const BOOTSTRAP_DIALOG_FILENAME					= 'bootstrap/bootstrap3-dialog/bootstrap-dialog.min.js';		// Bootstrap Dialog拡張
