...
//
// --------------------------------------------------------------------------------
// $Id: pclzip.lib.php 3322 2010-07-02 02:43:07Z fishbone $
// --------------------------------------------------------------------------------
    ...
    if ($p_entry['status'] == 'ok') {
      ...
      if (!(($p_entry['external']&0x00000010)==0x00000010))
      {
        ...
        if ($p_entry['compression'] == 0) {
          ...
          @touch($p_entry['filename'], $p_entry['mtime']);			// put warning off when file owner is different user. by naoki (2010/7/2)
        }
        else {
