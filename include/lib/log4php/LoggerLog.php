...
class LoggerLog {
	...
	static function log($message, $errLevel = E_USER_NOTICE)		// C³(2006/12/12)
    {
    ...
    static function internalDebugging($value = null)		// C³(2006/12/12)
    {
        static $debug = false;
	...
	static function debug($message)		// C³(2006/12/12)
    {
	...
	static function error($message)		// C³(2009/3/3)
    {
	...
	static function warn($message)		// C³(2009/3/3)
    {
