...
class LoggerManager {
	...
	static function getLogger($name, $factory = null)		// C³(2006/12/12)
    {
        //$repository =& LoggerManager::getLoggerRepository();
		$repository = LoggerManager::getLoggerRepository();// C³(2006/12/12)
     ...
     */
 //   function &getLoggerRepository()// C³(2006/12/11)
...
function LoggerManagerDefaultInit()
{
    ...
    if (class_exists($configuratorClass)) {
		...
		$object = new $configuratorClass;// C³(2006/12/11)
		return call_user_func(array($object, 'configure'), LOG4PHP_CONFIGURATION);        
    } else {
