...
class LoggerLevel {
    ...
    function equals($o)
    {
		...
		if ($o instanceof LoggerLevel){		// C³(2006/12/12)
	...
	static function getLevelInfo()		// C³(2006/12/12)
    {
        static $level;
	...
	static function getLevelDebug()		// C³(2006/12/12)
    {
        static $level;
     ...
     * @return LoggerLevel
     */
    //function &getLevelAll()		// 2006/12/12
	...
	static function toLevel($arg, $defaultLevel = null)		// C³(2006/12/12)
    {
