...
/* --------------------------------------------------------------------------*/
    ...
    function addFilter($newFilter)
    {
        if($this->headFilter === null) {
			...
			$this->tailFilter = $this->headFilter;// C³(2006/12/12)
        } else {
            $this->tailFilter->next = $newFilter;
            //$this->tailFilter =& $this->tailFilter->next;
			$this->tailFilter = $this->tailFilter->next;// C³(2006/12/12)
        }
    }
	...
	function getErrorHandler()		// C³(2006/12/12)
    {
     ...
     */
    //function &getFilter()
	function getFilter()			// C³(2006/12/12)
    {
	...
	function getFirstFilter()		// C³(2006/12/12)
    {
        return $this->headFilter;
    }
     ...
     */
    //function &getLayout()
	function getLayout()		// C³(2006/12/12)
    {
        return $this->layout;
    }
	...
	function getThreshold()		// C³(2006/12/12)
    { 
    ...
    function setThreshold($threshold)
    {
		...
		} elseif ($threshold instanceof LoggerLevel){		// C³(2006/12/12)
