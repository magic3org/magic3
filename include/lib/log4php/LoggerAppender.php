...
class LoggerAppender {
	...
	static function factory($name, $class)		// èCê≥(2006/12/12)
    {
	...
	static function singleton($name, $class = '')		// èCê≥(2006/12/12)
    {
        static $instances;
     ...
     */
    //function &getFilter()
	function getFilter()	// èCê≥(2006/12/12)
    {
        // override    
    } 
	...
	function getErrorHandler()			// èCê≥(2006/12/12)
    {
     ...
     */
    //function &getLayout()
	function getLayout()	// èCê≥(2006/12/12)
    {
        // override me
    }
