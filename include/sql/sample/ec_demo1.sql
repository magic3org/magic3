...
-- システム設定
UPDATE _system_config SET sc_value = 'magic3_demo3' WHERE sc_id = 'default_template';
...
(102,   100,          1,        'admin_menu', 'pagedef_smartphone',  0,           '',       'スマートフォン用画面', 'スマートフォン用画面編集',       'スマートフォン用Webサイトの画面を作成します。'),
(103,   100,          2,        'admin_menu', 'pagedef_mobile',  0,               '',       '携帯用画面',       '携帯用画面編集',       '携帯用Webサイトの画面を作成します。'),
...
('', 5,     'ja',           'ようこそ',   'ようこそ', '<p>ようこそ、Magic3携帯ショップデモサイトへ。</p><p>このサイトはMagic3を使って、Eコマースシステムを作ったデモサイトです。</p><p>&nbsp;</p>',              false, '',                0, now()),
