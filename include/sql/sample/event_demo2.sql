...
'',     ''),
('index', 'event',   'main',         6,        'evententry_attachment',          0,            '',                   'イベント予約',       '',          true,
'',     ''),
...
(et_id, et_event_id, et_code,    et_html,              et_status, et_max_entry) VALUES
(1,     '1',         'eve00001', '参加費は無料です。', 2,         100),
(2,     '2',         'eve00002', '参加費は無料です。', 2,         20),
(3,     '3',         'eve00003', '参加費は無料です。', 2,         10),
(4,     '4',         'eve00004', '参加費は無料です。', 2,         0),
(5,     '5',         'eve00005', '参加費は無料です。', 2,         120),
(6,     '6',         'eve00006', '参加費は無料です。', 2,         100),
(7,     '7',         'eve00007', '参加費は無料です。', 2,         0),
(8,     '8',         'eve00008', '参加費は無料です。', 2,         2),
(9,     '9',         'eve00009', '参加費は無料です。', 2,         10),
(10,    '10',        'eve00010', '参加費は無料です。', 2,         100),
(11,    '11',        'eve00011', '参加費は無料です。', 2,         100),
(12,    '12',        'eve00012', '参加費は無料です。', 2,         100),
(13,    '13',        'eve00013', '参加費は無料です。', 2,         100),
(14,    '14',        'eve00014', '参加費は無料です。', 2,         100),
(15,    '15',        'eve00015', '参加費は無料です。', 2,         100),
(16,    '16',        'eve00016', '参加費は無料です。', 2,         100),
(17,    '17',        'eve00017', '参加費は無料です。', 2,         100),
(18,    '18',        'eve00018', '参加費は無料です。', 2,         100),
(19,    '19',        'eve00019', '参加費は無料です。', 2,         100),
(20,    '20',        'eve00020', '参加費は無料です。', 2,         100);

-- イベント予約要求トラン
TRUNCATE TABLE evententry_request;
