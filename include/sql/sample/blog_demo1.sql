...
-- * @version    SVN: $Id: blog_demo1.sql 5926 2013-04-11 12:12:08Z fishbone $
-- * @link       http://www.magic3.org
-- *
-- [ブログサイトデモ1]
-- ##### 初心者の初回インストール時に最適 #####
-- 管理画面は、ブログ管理中心型。
-- 主要機能は、ブログ、汎用コンテンツ、バナー管理。
...
(10303,   10300,          2,        'admin_menu.en', 'mainte',                       '',          0,               '',       'System Maintenance', 'System Maintenance', 'Maintenance about file system and database.', true),
