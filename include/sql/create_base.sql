...
CREATE TABLE _templates (
    ...
    tm_type              INT            DEFAULT 0                     NOT NULL,      -- テンプレート種別(99=レイアウト用テンプレート,0=デフォルトテンプレート(Joomla!v1.0),1=Joomla!v1.5,2=Joomla!v2.5,10=Bootstrap v3.0,11=Bootstrap v4.0,20=jQuery Mobile,100=WordPress)
