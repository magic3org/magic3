...
CREATE TABLE _templates (
    ...
    tm_type              INT            DEFAULT 0                     NOT NULL,      -- テンプレート種別(99=レイアウト用テンプレート,0=デフォルトテンプレート(Joomla!v1.0),1=Joomla!v1.5,2=Joomla!v2.5,10=Bootstrap v3.0,11=Bootstrap v4.0,12=Bootstrap v5.0,100=WordPress)
...
CREATE TABLE _page_id (
    ...
    pg_function_type     VARCHAR(20)    DEFAULT ''                    NOT NULL,      -- システム用機能タイプ(activate=ウィジェット有効化)
...
CREATE TABLE _menu_id (
    ...
    mn_type              INT            DEFAULT 0                     NOT NULL,      -- メニュータイプ(0=単階層、1=多階層)(廃止予定)
