...
('wiki_main', 'Wiki-メイン', 'wiki', 'wiki', false,         '1.6.0',    'Naoki Hirata', 'Magic3.org', 'GPL', 10, 'Wikiを表示する。', 'md5', 'md5',         false,           true,       true,         true,        true,        false,               false,true,               0, 1, 2, '2012-06-09', now(),    now());
