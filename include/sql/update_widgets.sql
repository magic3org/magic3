...
('pretty_photo', 'プリティフォト', '2.0.1',    'Naoki Hirata', 'Magic3.org', 'GPL',      10, 'サムネール表示した画像を拡大します。', 'jquery.prettyphoto', 'jquery.tablednd,jquery.prettyphoto,jquery-ui.dialog,jquery-ui.slider,elfinder',               false,           false,       true,         true,        true,         true,                                true,                true,              0,  3,             1, '2013-09-15', now(),         now());
