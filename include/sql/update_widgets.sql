...
('admin_menu4', '管理用メニュー4', true,     'menu',  'admin',        '1.0.0',    'Naoki Hirata', 'Magic3.org', 'GPL',      10,                'bootstrap.toggle', false,        false,       true, true,           100,     '2018-02-10',        now(),         now());
...
('breadcrumb', 'パンくずリスト', 'breadcrumb', 'menu',         'bootstrap',      '4.1.0',    '株式会社 毎日メディアサービス', '株式会社 毎日メディアサービス', 'GPL',      10,                'メニュー定義からパンくずリストを作成', '',                'jquery.uploadfile', true,        true,           0, '2018-05-09', now(),    now());
...
('default_content', '汎用コンテンツ-デフォルトコンテンツ', 'content', 'content',       'content',      true,            '3.3.0',  'Naoki Hirata', 'Magic3.org', 'GPL', 10, '汎用コンテンツを管理し、画面に表示します。',          '',           'content_detail=md5,ckeditor_m3toolbar,jquery.tablednd;other=ckeditor_m3toolbar',       true,         true,        true,         true,               false,true,           0, '2018-03-20', now(), now());
...
('contactus_freelayout3', 'フリーレイアウトお問い合わせ3', '2.2.1',    '株式会社 毎日メディアサービス', '株式会社 毎日メディアサービス', 'GPL',      10,                'フリーレイアウトでカスタマイズ可能なお問い合わせメール送信機能。「フリーレイアウトお問い合わせ」のバージョンアップ版。', false,           false,     'jquery.formtips,jquery.format,jquery.calculation,jquery.uploadfile', 'jquery.tablednd,ckeditor_m3toolbar', true,         true,               true,                true, 0,          0, '2018-04-12', now(),         now());
...
('skyway', 'SkyWay', '1.0.0',    'Naoki Hirata', 'Magic3.org', 'GPL',      10,                1,         'SkyWayサンプルプログラム', true,        true,         true,                false,               true,           '2018-04-26',  now(),         now());
