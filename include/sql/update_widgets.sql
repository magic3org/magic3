...
('reg_user', '汎用会員登録', 'member',        'member',       true,            'member_main',        '2.0.2',    'Naoki Hirata', 'Magic3.org', 'GPL',      10,                '汎用的な会員登録機能です。「デフォルトログイン」ウィジェットと連携できます。', 'md5', true, true,        true,           '2015-05-12', now(), now());
-- ウィジェット情報(PC用/画像)
