...
('g_analytics2', 'Google Analytics2', '0.8.0',    'Naoki Hirata', 'Magic3.org', 'GPL',      10,                'グローバル サイトタグ(gtag.js)タイプのGoogle Analytics トラッキングコードを出力する。', true,         true,           now(),         now());
...
('css_add', 'CSS追加',  'bootstrap,wordpress', '3.0.0',    '',        'Naoki Hirata', 'Magic3.org', 'GPL',      10, 'テンプレートのCSSに加えてCSS定義やCSSファイルを追加するウィジェットです。',               false,           false,       true,         true,        true,         false,                                true,                true,              0,  3,             1, '2018-09-13', now(),         now());
