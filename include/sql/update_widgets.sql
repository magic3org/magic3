...
('whatsnew', '新着情報-簡易', 1, 'news',          'subcontent',   true,  'default_news',          '1.0.0b',   'Naoki Hirata', 'Magic3.org', 'GPL',      10,                'サイトの最新情報をリスト表示する。', '',                '',                 true,  false, true,      true,                true,  '2014-06-30', now(),         now());
...
('default_news', '新着情報-メイン', 1, 'news',          'subcontent',   true,  '',          '1.0.0b',   'Naoki Hirata', 'Magic3.org', 'GPL',      10,                '最新情報管理ウィジェット', '',                'elfinder',                false,  true,         false,                true,  '2014-06-30', now(),         now());
-- ウィジェット情報(PC用/検索)
