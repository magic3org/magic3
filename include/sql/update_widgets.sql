...
('default_content', '汎用コンテンツ - デフォルトコンテンツ', 'content', 'content',       'content',      true,            '2.3.0',  'Naoki Hirata', 'Magic3.org', 'GPL', 10, '画像やテキストからできた様々なコンテンツを表示。表示コンテンツはURLパラメータで指定。',          '',           'content_detail=ckeditor_toolbar,jquery.tablednd',       true,         true,        true,         true,               false,true,           0, 2, 2, '2012-08-18', now(), now());
