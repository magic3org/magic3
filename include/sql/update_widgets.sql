...
('custom_search', 'カスタム検索', 'search',        'search',       '3.0.1',    '株式会社 毎日メディアサービス', '株式会社 毎日メディアサービス', 'GPL',      10,                '各種コンテンツが検索可能で表示レイアウトもカスタマイズ可能な検索ウィジェット', 'jquery', 'jquery.tablednd,ckeditor_m3toolbar', true, false, true, true,          1, -1, '2015-10-28', now(), now());
