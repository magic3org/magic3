<?php
/**
 * スマートフォンアクセスポイント(index.php)用コンテナクラス
 *
 * PHP versions 5
 *
 ...
 * @version    SVN: $Id: s_indexFrameContainer.php 3086 2010-04-30 08:07:52Z fishbone $
 * @link       http://www.magic3.org
 */
require_once($gEnvManager->getContainerPath() . '/baseFrameContainer.php');

class s_indexFrameContainer extends BaseFrameContainer
{
	/**
	 * コンストラクタ
	 */
