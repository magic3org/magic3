<?php
/**
* @version		$Id: simplexml.php 1962 2009-06-03 11:17:48Z fishbone $
...
//		$this->_parser = xml_parser_create('');
		$this->_parser = xml_parser_create(M3_ENCODING);		// 日本語を処理
	...
	function _handleError($code, $line, $col)
	{
		...
		debug( 'SOME_ERROR_CODE: XML Parsing Error at '.$line.':'.$col.'. Error '.$code.': '.xml_error_string($code));
	}
