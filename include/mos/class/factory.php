<?php
/**
 * @version		$Id: factory.php 5538 2013-01-10 09:53:17Z fishbone $
...
//			jimport( 'joomla.application.application' );
			...
			// JApplicationクラスを読み込む
			require_once($gEnvManager->getJoomlaRootPath() . '/class/application.php');
...
//				jimport('joomla.utilities.simplexml');
				require_once($gEnvManager->getJoomlaRootPath() . '/class/simplexml.php');
				$doc = new JSimpleXML();
			}	break;
...
//		jimport('joomla.environment.uri');
	...
	public static function getDate($time = 'now', $tzOffset = 0)
	{
		...
		// JDateクラスを読み込む
		if (phpversion() < '5.2.0'){
			require_once($gEnvManager->getJoomlaRootPath() . '/class/date_old.php');
		} else {
			require_once($gEnvManager->getJoomlaRootPath() . '/class/date.php');
		}
	 ...
	 * @since 1.5
	 */
	protected static function _createConfig($file, $type = 'PHP')
	{
...
/*		$session = JSession::getInstance($handler, $options);
	 ...
	 * @since 1.5
	 */
	protected static function _createACL()
	{
...
//		jimport('joomla.mail.mail');
	 ...
	 * @since 1.5
	 */
	protected static function _createTemplate($files = array())
	{
