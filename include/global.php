...
define('M3_DB_ERROR_OUTPUT_QUERY',		false);		// エラーメッセージにクエリー文字列を出力するかどうか
...
define('M3_SYSTEM_VERSION',			'2.13.7');		// システムのバージョン
define('M3_SYSTEM_RELEASE_DATE',	'2015/8/30');	// システムのリリース日付
