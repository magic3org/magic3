 ...
 * @version    SVN: $Id: admin_dbfixInstallWidgetContainer.php 2859 2010-02-16 03:48:52Z fishbone $
 * @link       http://www.magic3.org
 */
require_once($gEnvManager->getContainerPath() .	'/baseInstallWidgetContainer.php');

class admin_dbfixInstallWidgetContainer extends BaseInstallWidgetContainer
{
	/**
	 * コンストラクタ
	 */
