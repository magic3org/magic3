...
$HELP['untitled_image']['title'] = '画像';
$HELP['untitled_image']['body'] = '表示する画像を「ディレクトリ画像」または「フォトギャラリー画像」で指定します。<br />●ディレクトリ画像<br />指定のディレクトリから画像ファイルを取得します。<br />●フォトギャラリー画像<br />「フォトギャラリー」コンテンツから画像を取得します。';
