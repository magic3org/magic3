...
class photoslide2WidgetContainer extends BaseWidgetContainer
{
	...
	function itemLoop($index, $fetchedRow, $param)
	{
		...
		$imageTag = '<a href="' . $this->convertUrlToHtmlEntity($urlLink) . '"><img src="' . $this->convertUrlToHtmlEntity($imageUrl) . '" alt="' . $dispTitle . '" title="' . $dispTitle . '" /></a>';
		$row = array(
