 ...
 * @version    SVN: $Id: index.php 3248 2010-06-16 07:09:38Z fishbone $
...
$HELP['contactus_field']['body'] = 'お問い合わせ項目を定義します。「定義」の記述方法は以下の通りです。(m,nは数値、str,valは文字列を示します。)<br />●テキストボックス<br />「size=m」でフィールドサイズを設定します。<br />●テキストエリア<br />「rows=m;cols=n」で行、列数を設定します。<br />●セレクトメニュー,チェックボックス,ラジオボタン<br />「str1;str2;str3;...」<br />表示値、送信値が異なる場合は「str1=val1;str2=val2;str3=val3;...」<br />チェックボックス、ラジオボタンの場合は、「;」が連続した空項目があると改行(BRタグ)を挿入します。';
...
$HELP['contactus_user_email']['body'] = 'お問い合わせ項目タイプが「テキストボックス(Eメール)」のアドレス宛に確認メールを送信する場合の設定を行います。基本情報のメールアドレスが送信元になり、「送信元メールアドレス」が設定されます。<br />「本文」の「[#BODY#]」には「メール送信」のメール内容が挿入されます。';
