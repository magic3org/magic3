...
$HELP['contactus_template']['title'] = 'レイアウト';
$HELP['contactus_template']['body'] = 'お問い合わせ画面のレイアウトを作成します。<br />[#ITEM_KEY_n#](nはお問い合わせ項目のNoを指定)形式のタグを埋め込むとその位置に該当するお問い合わせ項目が表示できます。';
