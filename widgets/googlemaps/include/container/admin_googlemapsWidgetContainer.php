 ...
 * @version    SVN: $Id: admin_googlemapsWidgetContainer.php 4766 2012-03-19 02:22:15Z fishbone $
 * @link       http://www.m-media.co.jp
 */
require_once($gEnvManager->getContainerPath() . '/baseAdminWidgetContainer.php');

class admin_googlemapsWidgetContainer extends BaseAdminWidgetContainer
{
	...
	const DEFAULT_WIDTH = 400;		// デフォルトの幅
	const DEFAULT_HEIGHT = 400;		// デフォルトの高さ
