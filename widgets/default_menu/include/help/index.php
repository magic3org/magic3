...
// ########## メニュー項目一覧 ##########
$HELP['menu_list']['title'] = '設定一覧';
$HELP['menu_list']['body'] = '登録されている設定の一覧です。';
$HELP['menu_detail']['title'] = '基本設定';
...
$HELP['menu_name']['body'] = '設定名です。メニューのタイトルにも使用されます。';
$HELP['menu_name_input']['title'] = '名前';
$HELP['menu_name_input']['body'] = '設定名です。新規に登録するか、登録済みの設定を選択します。';
$HELP['menu_id']['title'] = '設定ID';
$HELP['menu_id']['body'] = '自動的に振られる設定IDです。';
$HELP['menu_access_control']['title'] = 'アクセス制御';
$HELP['menu_access_control']['body'] = 'メニューの表示制御を行います。';
...
$HELP['menu_ref']['body'] = '設定を使用しているウィジェット数を示します。使用が0の設定のみ削除可能です。';
$HELP['menu_list_btn']['title'] = '一覧ボタン';
$HELP['menu_list_btn']['body'] = '設定一覧を表示します。';
$HELP['menu_del_btn']['title'] = '削除ボタン';
$HELP['menu_del_btn']['body'] = '選択されている設定を削除します。<br />項目を選択するには、一覧の左端のチェックボックスにチェックを入れます。';
$HELP['menu_ret_btn']['title'] = '戻るボタン';
$HELP['menu_ret_btn']['body'] = '基本設定へ戻ります。';
?>
