...
require_once($gEnvManager->getCurrentWidgetDbPath() . '/event_category_menuDb.php');

class event_category_menuWidgetContainer extends BaseWidgetContainer
{
	...
	function __construct()
	{
		...
		// DBオブジェクト作成
		$this->db = new event_category_menuDb();
	}
	/**
	 * テンプレートファイルを設定
	 *
	...
	function categoryListLoop($index, $fetchedRow, $param)
	{
		...
		$linkUrl = $this->createCmdUrlToWidget(self::TARGET_WIDGET, 'act=view&' . M3_REQUEST_PARAM_CATEGORY_ID . '=' . $fetchedRow['ec_id']);
		$row = array(
