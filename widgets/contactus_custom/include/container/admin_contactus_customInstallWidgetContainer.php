 ...
 * @version    SVN: $Id: admin_contactus_customInstallWidgetContainer.php 2915 2010-03-14 08:22:11Z fishbone $
 * @link       http://www.magic3.org
 */
require_once($gEnvManager->getContainerPath() .	'/baseInstallWidgetContainer.php');

class admin_contactus_customInstallWidgetContainer extends BaseInstallWidgetContainer
{
	/**
	 * コンストラクタ
	 */
