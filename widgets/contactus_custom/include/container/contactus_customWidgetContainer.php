 ...
 * @version    SVN: $Id: contactus_customWidgetContainer.php 2915 2010-03-14 08:22:11Z fishbone $
 * @link       http://www.magic3.org
 */
require_once($gEnvManager->getContainerPath() . '/baseWidgetContainer.php');
require_once($gEnvManager->getCurrentWidgetDbPath() . '/contactus_customDb.php');

class contactus_customWidgetContainer extends BaseWidgetContainer
{
