 ...
 * @version    SVN: $Id: admin_productrateWidgetContainer.php 5436 2012-12-07 09:55:12Z fishbone $
 * @link       http://www.magic3.org
 */
require_once($gEnvManager->getContainerPath() . '/baseIWidgetContainer.php');

class admin_productrateWidgetContainer extends BaseIWidgetContainer
{
	/**
	 * コンストラクタ
	 */
