...
//	const CF_TITLE_TAG_LEVEL		= 'title_tag_level';		// タイトルのタグレベル
	...
	const DEFAULT_LAYOUT_ENTRY_LIST_SUMMARY = '[#TITLE#]<small>[#CT_AUTHOR#] [#CT_DATE#] [#CT_TIME#] [#BLOG_LINK#]</small><div class="media"><div class="media-left">[#IMAGE#]</div><div class="media-body">[#BODY#]</div></div>';	// デフォルトのコンテンツレイアウト(記事一覧概要表示)
