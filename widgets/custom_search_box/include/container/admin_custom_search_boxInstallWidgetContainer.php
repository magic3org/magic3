 ...
 * @version    SVN: $Id: admin_custom_search_boxInstallWidgetContainer.php 3609 2010-09-21 03:55:36Z fishbone $
 * @link       http://www.magic3.org
 */
require_once($gEnvManager->getContainerPath() .	'/baseInstallWidgetContainer.php');

class admin_custom_search_boxInstallWidgetContainer extends BaseInstallWidgetContainer
{
	/**
	 * コンストラクタ
	 */
