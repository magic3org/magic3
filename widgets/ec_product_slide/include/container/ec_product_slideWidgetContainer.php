 ...
 * @version    SVN: $Id: ec_product_slideWidgetContainer.php 5428 2012-12-05 23:10:08Z fishbone $
...
class ec_product_slideWidgetContainer extends BaseWidgetContainer
{
	...
	const DEFAULT_TITLE = '商品スライド表示';	// デフォルトのタイトル
	...
	function _assign($request, &$param)
	{
		...
		$this->categoryId = $categoryId;		// URLパラメータのカテゴリーを保存
