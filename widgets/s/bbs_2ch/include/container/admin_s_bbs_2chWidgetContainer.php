 ...
 * @version    SVN: $Id: admin_s_bbs_2chWidgetContainer.php 4851 2012-04-15 00:43:29Z fishbone $
 * @link       http://www.magic3.org
 */
require_once($gEnvManager->getCurrentWidgetContainerPath() . '/admin_s_bbs_2chBaseWidgetContainer.php');

class admin_s_bbs_2chWidgetContainer extends admin_s_bbs_2chBaseWidgetContainer
{
	/**
	 * コンストラクタ
	 */
