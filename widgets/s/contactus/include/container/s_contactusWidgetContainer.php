 ...
 * @version    SVN: $Id: s_contactusWidgetContainer.php 4631 2012-01-30 08:41:25Z fishbone $
 * @link       http://www.magic3.org
 */
require_once($gEnvManager->getContainerPath() .			'/baseWidgetContainer.php');
require_once($gEnvManager->getCurrentWidgetDbPath() .	'/s_contactusDb.php');

class s_contactusWidgetContainer extends BaseWidgetContainer
{
	...
	const DEFAULT_STR_REQUIRED = '<span class="required" style="color:red;">*必須</span>';		// 「必須」表示用テキスト
