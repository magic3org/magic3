 ...
 * @version    SVN: $Id: admin_s_contactusWidgetContainer.php 6104 2013-06-13 12:07:50Z fishbone $
 * @link       http://www.magic3.org
 */
require_once($gEnvManager->getContainerPath() .			'/baseAdminWidgetContainer.php');
require_once($gEnvManager->getCurrentWidgetDbPath() .	'/s_contactusDb.php');

class admin_s_contactusWidgetContainer extends BaseAdminWidgetContainer
{
