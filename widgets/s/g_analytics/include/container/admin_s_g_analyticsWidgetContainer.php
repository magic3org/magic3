 ...
 * @version    SVN: $Id: admin_s_g_analyticsWidgetContainer.php 3721 2010-10-19 09:41:58Z fishbone $
 * @link       http://www.magic3.org
 */
require_once($gEnvManager->getContainerPath() . '/baseAdminWidgetContainer.php');

class admin_s_g_analyticsWidgetContainer extends BaseAdminWidgetContainer
{
	/**
	 * コンストラクタ
	 */
