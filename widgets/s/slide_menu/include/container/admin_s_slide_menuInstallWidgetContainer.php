 ...
 * @version    SVN: $Id: admin_s_slide_menuInstallWidgetContainer.php 3124 2010-05-13 05:41:33Z fishbone $
 * @link       http://www.magic3.org
 */
require_once($gEnvManager->getContainerPath() .	'/baseInstallWidgetContainer.php');

class admin_s_slide_menuInstallWidgetContainer extends BaseInstallWidgetContainer
{
	/**
	 * コンストラクタ
	 */
