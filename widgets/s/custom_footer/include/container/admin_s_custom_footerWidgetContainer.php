 ...
 * @version    SVN: $Id: admin_s_custom_footerWidgetContainer.php 3440 2010-07-30 03:47:05Z fishbone $
 * @link       http://www.magic3.org
 */
require_once($gEnvManager->getContainerPath() . '/baseAdminWidgetContainer.php');

class admin_s_custom_footerWidgetContainer extends BaseAdminWidgetContainer
{
	/**
	 * コンストラクタ
	 */
