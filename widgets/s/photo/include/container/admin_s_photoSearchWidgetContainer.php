 ...
 * @version    SVN: $Id: admin_s_photoSearchWidgetContainer.php 4713 2012-02-23 15:21:44Z fishbone $
...
class admin_s_photoSearchWidgetContainer extends admin_s_photoBaseWidgetContainer
{
...
//	const DEFAULT_SEARCH_AREA = 'default_search.tmpl.html';		// デフォルトの検索エリア
	...
	function createDetail($request)
	{
		...
		$tagStr = photoCommonDef::SEARCH_TEXT_ID . '(入力フィールドのID), ' . photoCommonDef::SEARCH_BUTTON_ID . '(検索実行ボタンのID), ' . photoCommonDef::SEARCH_RESET_ID . '(検索リセットボタンのID), ' . photoCommonDef::SEARCH_SORT_ID . '(ソートメニューのID)';
