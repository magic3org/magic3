 ...
 * @version    SVN: $Id: index.php 4574 2012-01-06 05:34:41Z fishbone $
...
$HELP['entry_status']['body'] = 'ブログ記事の状態を示します。「公開」はユーザから閲覧できる状態です。「非公開」はユーザから閲覧できない状態です。「編集中」は記事が編集中でユーザから閲覧できない状態です。';
...
$HELP['entry_view_count']['body'] = 'ブログ記事の閲覧数です。管理権限ユーザの閲覧はカウントされません。';
...
$HELP['config_multi_blog_top_content']['body'] = 'マルチブログを使用した場合のトップ画面のコンテンツです。';
?>
