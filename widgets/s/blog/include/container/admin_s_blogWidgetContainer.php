 ...
 * @version    SVN: $Id: admin_s_blogWidgetContainer.php 4575 2012-01-09 02:13:07Z fishbone $
 * @link       http://www.magic3.org
 */
require_once($gEnvManager->getCurrentWidgetContainerPath() . '/admin_s_blogBaseWidgetContainer.php');

class admin_s_blogWidgetContainer extends admin_s_blogBaseWidgetContainer
{
	/**
	 * コンストラクタ
	 */
