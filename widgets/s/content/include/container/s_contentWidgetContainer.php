 ...
 * @version    SVN: $Id: s_contentWidgetContainer.php 5048 2012-07-20 09:59:14Z fishbone $
 * @link       http://www.magic3.org
 */
require_once($gEnvManager->getWidgetContainerPath('default_content') . '/default_contentWidgetContainer.php');

class s_contentWidgetContainer extends default_contentWidgetContainer
{
	/**
	 * コンストラクタ
	 */
