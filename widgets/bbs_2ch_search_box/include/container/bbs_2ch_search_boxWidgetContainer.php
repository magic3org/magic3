 ...
 * @version    SVN: $Id: bbs_2ch_search_boxWidgetContainer.php 4027 2011-03-10 07:41:03Z fishbone $
 * @link       http://www.magic3.org
 */
require_once($gEnvManager->getContainerPath()		. '/baseWidgetContainer.php');

class bbs_2ch_search_boxWidgetContainer extends BaseWidgetContainer
{
	const TARGET_WIDGET = 'bbs_2ch_main';		// 呼び出しウィジェットID
