 ...
 * @version    SVN: $Id: admin_contactusInstallWidgetContainer.php 2914 2010-03-14 08:00:47Z fishbone $
 * @link       http://www.magic3.org
 */
require_once($gEnvManager->getContainerPath() .	'/baseInstallWidgetContainer.php');

class admin_contactusInstallWidgetContainer extends BaseInstallWidgetContainer
{
	/**
	 * コンストラクタ
	 */
