 ...
 * @version    SVN: $Id: admin_user_contentInstallWidgetContainer.php 2921 2010-03-15 02:39:17Z fishbone $
 * @link       http://www.m-media.co.jp
 */
require_once($gEnvManager->getContainerPath() .	'/baseInstallWidgetContainer.php');

class admin_user_contentInstallWidgetContainer extends BaseInstallWidgetContainer
{
	/**
	 * コンストラクタ
	 */
