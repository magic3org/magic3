 ...
 * @version    SVN: $Id: index.php 5142 2012-08-27 03:42:07Z fishbone $
...
$HELP['banner_image']['title'] = '画像リンク';
$HELP['banner_image']['body'] = 'この設定で使用する画像リンク(画像とリンク先の組み合わせ)を指定します。';
$HELP['banner_disp_type']['title'] = '表示方法';
$HELP['banner_disp_type']['body'] = '画像リンクの表示方法を指定します。<br />「表示順」で画像リンクの取得方法を指定します。「順次」または「ランダム」での表示が可能です。<br />「表示方向」で画像の並び方を指定します。<br />「表示項目数」で一度に表示する画像の数を指定します。';
$HELP['banner_preview']['title'] = '画像リンク一覧';
$HELP['banner_preview']['body'] = 'この設定で表示する画像リンクを一覧表示します。';
...
$HELP['banner_image_btn']['title'] = '画像リンク変更';
$HELP['banner_image_btn']['body'] = '画像リンク選択用のダイアログを表示します。選択用のチェックボックスにチェックを入れて画像リンクを選択します。項目選択後「確定」ボタンを押すと選択が反映されます。';

// ########## 画像リンク管理 ##########
$HELP['image_list']['title'] = '画像リンク一覧';
$HELP['image_list']['body'] = '登録されている画像リンクの一覧です。';
$HELP['image_detail']['title'] = '画像リンク';
...
$HELP['image_name']['body'] = '画像リンク名です。';
$HELP['image_name_input']['title'] = '名前';
$HELP['image_name_input']['body'] = '画像リンク名です。新規に登録するか、登録済みの設定を選択します。';
$HELP['image_id']['title'] = '画像リンクID';
$HELP['image_id']['body'] = '自動的に振られる画像リンクIDです。';
...
$HELP['image_visible']['body'] = '画像リンクををユーザに公開するかどうかを制御します。非公開に設定の場合はユーザから参照することはできません。';
...
$HELP['image_update_dt']['body'] = '画像リンク情報の更新日時を示します。';
$HELP['image_update_user']['title'] = '更新者';
$HELP['image_update_user']['body'] = '画像リンク情報の更新者を示します。';
$HELP['image_new_btn']['title'] = '新規ボタン';
$HELP['image_new_btn']['body'] = '画像リンクを追加します。';
$HELP['image_edit_btn']['title'] = '編集ボタン';
$HELP['image_edit_btn']['body'] = '選択されている画像リンク項目を編集します。<br>選択するには、一覧の左端のチェックボックスにチェックを入れます。';
$HELP['image_del_btn']['title'] = '削除ボタン';
$HELP['image_del_btn']['body'] = '選択されている画像リンクを削除します。<br />項目を選択するには、一覧の左端のチェックボックスにチェックを入れます。';
$HELP['image_ret_btn']['title'] = '戻るボタン';
$HELP['image_ret_btn']['body'] = '画像リンク一覧へ戻ります。';
?>
