 ...
 * @version    SVN: $Id: admin_banner3WidgetContainer.php 5859 2013-03-26 06:14:45Z fishbone $
...
class admin_banner3WidgetContainer extends admin_banner3BaseWidgetContainer
{
	/**
	 * コンストラクタ
	 */
	...
	function _dispatch($request, &$param)
	{
		...
		if (empty($task)) $task = 'banner';		// デフォルトの画面
		...
		if ($goWidget){		// サブウィジェットを実行するかどうか
			$this->gLaunch->goSubWidget($task, true, default_bannerCommonDef::BANNER_WIDGET_ID);		// 管理者機能で呼び出し
			return false;
		} else {
