 ...
 * @version    SVN: $Id: admin_ec_menuWidgetContainer.php 5317 2012-10-25 12:50:04Z fishbone $
 * @link       http://www.magic3.org
 */
require_once($gEnvManager->getCurrentWidgetContainerPath() . '/admin_ec_menuBaseWidgetContainer.php');

class admin_ec_menuWidgetContainer extends admin_ec_menuBaseWidgetContainer
{
	/**
	 * コンストラクタ
	 */
