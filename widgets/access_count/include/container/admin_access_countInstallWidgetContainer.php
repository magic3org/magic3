 ...
 * @version    SVN: $Id: admin_access_countInstallWidgetContainer.php 3179 2010-06-02 05:29:25Z fishbone $
 * @link       http://www.magic3.org
 */
require_once($gEnvManager->getContainerPath() .	'/baseInstallWidgetContainer.php');

class admin_access_countInstallWidgetContainer extends BaseInstallWidgetContainer
{
	/**
	 * コンストラクタ
	 */
