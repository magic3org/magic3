...
<form action="$postScript" method="post" class="form">
 <div>
  ...
  <input type="password" name="password" id="_p_update_entities_adminpass" size="12" />
  <input type="submit" class="button" value="{$_entities_messages['btn_submit']}" onclick="this.form.pass.value = hex_md5(this.form.password.value);" />
 </div>
</form>
EOD;
		}
...
//			or die_message('cannot receive ' . W3C_XHTML_DTD_LOCATION . $file . '.');
	...
	WikiPage::updateEntityData($pattern);
	/*
