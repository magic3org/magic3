 ...
 * @version    SVN: $Id: referer.inc.php 1141 2008-10-27 06:10:58Z fishbone $
...
function plugin_referer_action()
{
	...
	if (is_page($page)){
		...
		$sort = (WikiParam::getVar('sort') == '') ? '0d' : WikiParam::getVar('sort');
		return array(
...
//		$sort_ctr = '2d';
	...
	$href = $script . WikiParam::convQuery('?plugin=referer&amp;page=' . rawurlencode($page));
	return <<<EOD
