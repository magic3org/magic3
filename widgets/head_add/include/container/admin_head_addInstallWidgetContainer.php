 ...
 * @version    SVN: $Id: admin_head_addInstallWidgetContainer.php 3258 2010-06-18 10:25:21Z fishbone $
 * @link       http://www.magic3.org
 */
require_once($gEnvManager->getContainerPath() .	'/baseInstallWidgetContainer.php');

class admin_head_addInstallWidgetContainer extends BaseInstallWidgetContainer
{
	/**
	 * コンストラクタ
	 */
