 ...
 * @version    SVN: $Id: admin_slide_menuInstallWidgetContainer.php 2887 2010-03-04 08:53:54Z fishbone $
 * @link       http://www.magic3.org
 */
require_once($gEnvManager->getContainerPath() .	'/baseInstallWidgetContainer.php');

class admin_slide_menuInstallWidgetContainer extends BaseInstallWidgetContainer
{
	/**
	 * コンストラクタ
	 */
