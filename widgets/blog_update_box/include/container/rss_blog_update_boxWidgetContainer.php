 ...
 * @version    SVN: $Id: rss_blog_update_boxWidgetContainer.php 5267 2012-10-04 11:33:36Z fishbone $
...
class rss_blog_update_boxWidgetContainer extends BaseRssContainer
{
	private $db;
	...
	const DEFAULT_TITLE = 'ブログ更新記事';			// デフォルトのウィジェットタイトル
	const DEFAULT_DESC = '更新されたブログ記事が取得できます。';
	...
	function itemLoop($index, $fetchedRow)
	{
		...
		if (!empty($name)){
			$row = array(
				...
				'date' => getW3CDate($fetchedRow['be_dt'])		// 更新日時
			);
