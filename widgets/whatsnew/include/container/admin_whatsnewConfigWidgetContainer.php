 ...
 */
require_once($gEnvManager->getWidgetContainerPath('whatsnew') . '/admin_whatsnewBaseWidgetContainer.php');

class admin_whatsnewConfigWidgetContainer extends admin_whatsnewBaseWidgetContainer
{
