 ...
 * @version    SVN: $Id: admin_static_contentInstallWidgetContainer.php 3158 2010-05-26 02:31:10Z fishbone $
 * @link       http://www.magic3.org
 */
require_once($gEnvManager->getContainerPath() .	'/baseInstallWidgetContainer.php');

class admin_static_contentInstallWidgetContainer extends BaseInstallWidgetContainer
{
	/**
	 * コンストラクタ
	 */
