 ...
 * @version    SVN: $Id: admin_contactus_modalWidgetContainer.php 2244 2009-08-24 04:33:20Z fishbone $
 * @link       http://www.magic3.org
 */
require_once($gEnvManager->getContainerPath() . '/baseAdminWidgetContainer.php');

class admin_contactus_modalWidgetContainer extends BaseAdminWidgetContainer
{
	...
	function createDetail($request)
	{
		...
		//$this->css	= $request->trimValueOf('item_css');		// CSS
