...
$HELP['pagehead_description']['body'] = 'ヘッダ部のdescriptionタグに設定される文字列です。120文字程度で記述します。<br />Googleでは検索結果に表示されます。';
...
$HELP['pageid_available']['title'] = 'メニュー項目';
$HELP['pageid_available']['body'] = '管理画面でメニューから選択可能にする場合はチェックを入れます。';
