...
$HELP['accesspoint_active']['body'] = 'アクセスポイントを有効にするかどうかを指定します。有効なアクセスポイントは外部からアクセス可能なURLになります。';
...
$HELP['searchwordlog_user']['body'] = '検索を実行したユーザのログインユーザ名を示します。';
$HELP['searchwordlog_last_user']['title'] = '最終ユーザ名';
$HELP['searchwordlog_last_user']['body'] = '最後に検索を実行したユーザのログインユーザ名を示します。';
$HELP['searchwordlog_dt']['title'] = '日時';
$HELP['searchwordlog_dt']['body'] = '検索を実行した日時です。';
$HELP['searchwordlog_last_dt']['title'] = '最終日時';
$HELP['searchwordlog_last_dt']['body'] = '最後に検索を実行した日時です。';
